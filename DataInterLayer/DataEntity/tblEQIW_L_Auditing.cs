...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIW_L_Auditing : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIW_L_Auditing Clone()
        {
            tblEQIW_L_Auditing objNew = (tblEQIW_L_Auditing)this.MemberwiseClone();
            return objNew;
        }
