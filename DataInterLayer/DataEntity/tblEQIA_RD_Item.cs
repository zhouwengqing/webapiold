...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQIA_RD_Item : BaseDataEntity
	{
		[AttributePK]
		...
		/// </summary>
		/// <returns></returns>
		public tblEQIA_RD_Item Clone()
		{
			tblEQIA_RD_Item objNew = (tblEQIA_RD_Item)this.MemberwiseClone();
			return objNew;
		}
