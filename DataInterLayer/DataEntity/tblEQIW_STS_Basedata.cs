...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIW_STS_Basedata : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIW_STS_Basedata Clone()
        {
            tblEQIW_STS_Basedata objNew = (tblEQIW_STS_Basedata)this.MemberwiseClone();
            return objNew;
        }
