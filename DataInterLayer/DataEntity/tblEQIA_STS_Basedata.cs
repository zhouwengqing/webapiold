...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIA_STS_Basedata : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIA_STS_Basedata Clone()
        {
            tblEQIA_STS_Basedata objNew = (tblEQIA_STS_Basedata)this.MemberwiseClone();
            return objNew;
        }
