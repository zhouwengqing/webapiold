...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQIS_D_Point : BaseDataEntity
	{
		[AttributePK]
		...
		/// </summary>
		/// <returns></returns>
		public tblEQIS_D_Point Clone()
		{
			tblEQIS_D_Point objNew = (tblEQIS_D_Point)this.MemberwiseClone();
			return objNew;
		}
