...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIA_RPI_Basedata : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIA_RPI_Basedata Clone()
        {
            tblEQIA_RPI_Basedata objNew = (tblEQIA_RPI_Basedata)this.MemberwiseClone();
            return objNew;
        }
