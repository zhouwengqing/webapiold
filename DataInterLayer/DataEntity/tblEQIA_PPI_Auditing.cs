...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIA_PPI_Auditing : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIA_PPI_Auditing Clone()
        {
            tblEQIA_PPI_Auditing objNew = (tblEQIA_PPI_Auditing)this.MemberwiseClone();
            return objNew;
        }
