...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQIW_G_Auditing : BaseDataEntity
	{
		[AttributePK]
		...
		/// </summary>
		/// <returns></returns>
		public tblEQIW_G_Auditing Clone()
		{
			tblEQIW_G_Auditing objNew = (tblEQIW_G_Auditing)this.MemberwiseClone();
			return objNew;
		}
