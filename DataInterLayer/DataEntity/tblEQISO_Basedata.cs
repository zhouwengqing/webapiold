...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQISO_Basedata : BaseDataEntity
	{
		[AttributePK]
		...
		/// </summary>
		/// <returns></returns>
		public tblEQISO_Basedata Clone()
		{
			tblEQISO_Basedata objNew = (tblEQISO_Basedata)this.MemberwiseClone();
			return objNew;
		}
