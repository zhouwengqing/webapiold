...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIW_STS_Auditing_Auto : BaseDataEntity
    {
        [AttributePK]
        ...
        public tblEQIW_STS_Auditing_Auto()
        {
            base.InitMetaData();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIW_STS_Auditing_Auto Clone()
        {
            tblEQIW_STS_Auditing_Auto objNew = (tblEQIW_STS_Auditing_Auto)this.MemberwiseClone();
            return objNew;
        }
