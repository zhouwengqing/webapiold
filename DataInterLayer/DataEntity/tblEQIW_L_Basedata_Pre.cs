...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIW_L_Basedata_Pre : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIW_L_Basedata_Pre Clone()
        {
            tblEQIW_L_Basedata_Pre objNew = (tblEQIW_L_Basedata_Pre)this.MemberwiseClone();
            return objNew;
        }
