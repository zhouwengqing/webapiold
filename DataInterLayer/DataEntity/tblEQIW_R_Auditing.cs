...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIW_R_Auditing : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIW_R_Auditing Clone()
        {
            tblEQIW_R_Auditing objNew = (tblEQIW_R_Auditing)this.MemberwiseClone();
            return objNew;
        }
