...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQIW_R_Basedata_Pre : BaseDataEntity
	{
		[AttributePK]
		...
		/// </summary>
		/// <returns></returns>
		public tblEQIW_R_Basedata_Pre Clone()
		{
			tblEQIW_R_Basedata_Pre objNew = (tblEQIW_R_Basedata_Pre)this.MemberwiseClone();
			return objNew;
		}
