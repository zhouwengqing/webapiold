...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIW_D_Basedata : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIW_D_Basedata Clone()
        {
            tblEQIW_D_Basedata objNew = (tblEQIW_D_Basedata)this.MemberwiseClone();
            return objNew;
        }
