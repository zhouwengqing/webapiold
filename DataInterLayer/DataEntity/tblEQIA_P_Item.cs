...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQIA_P_Item : BaseDataEntity
	{
		[AttributePK]
		...
		private System.Decimal m_fldGramMete;

		private System.Decimal m_fldConductance;

		private System.Decimal m_fldPriceNum;

		private System.String m_fldIonType;

		private System.Boolean m_fldRender;

		private System.Int16 m_fldSort;

		public tblEQIA_P_Item()
		{
			base.InitMetaData();
		}
		...
		/// </summary>
		/// <returns></returns>
		public tblEQIA_P_Item Clone()
		{
			tblEQIA_P_Item objNew = (tblEQIA_P_Item)this.MemberwiseClone();
			return objNew;
		}
		...
		public System.Decimal fldGramMete
		{
			get
			{
				return this.m_fldGramMete;
			}
			set
			{
				this.m_fldGramMete=value;
			}
		}

		public System.Decimal fldConductance
		{
			get
			{
				return this.m_fldConductance;
			}
			set
			{
				this.m_fldConductance=value;
			}
		}

		public System.Decimal fldPriceNum
		{
			get
			{
				return this.m_fldPriceNum;
			}
			set
			{
				this.m_fldPriceNum=value;
			}
		}

		public System.String fldIonType
		{
			get
			{
				return this.m_fldIonType;
			}
			set
			{
				this.m_fldIonType=value;
			}
		}
