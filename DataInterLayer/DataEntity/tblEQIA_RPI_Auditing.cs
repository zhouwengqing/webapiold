...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIA_RPI_Auditing : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIA_RPI_Auditing Clone()
        {
            tblEQIA_RPI_Auditing objNew = (tblEQIA_RPI_Auditing)this.MemberwiseClone();
            return objNew;
        }
