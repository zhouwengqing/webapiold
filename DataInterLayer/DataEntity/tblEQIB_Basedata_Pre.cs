...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQIB_Basedata_Pre : BaseDataEntity
	{
		[AttributePK]
		...
		/// </summary>
		/// <returns></returns>
		public tblEQIB_Basedata_Pre Clone()
		{
			tblEQIB_Basedata_Pre objNew = (tblEQIB_Basedata_Pre)this.MemberwiseClone();
			return objNew;
		}
