...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQISE_Section : BaseDataEntity
	{
		[AttributePK]
		...
		/// </summary>
		/// <returns></returns>
		public tblEQISE_Section Clone()
		{
			tblEQISE_Section objNew = (tblEQISE_Section)this.MemberwiseClone();
			return objNew;
		}
