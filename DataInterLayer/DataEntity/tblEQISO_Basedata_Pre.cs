...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQISO_Basedata_Pre : BaseDataEntity
	{
		[AttributePK]
		...
		/// </summary>
		/// <returns></returns>
		public tblEQISO_Basedata_Pre Clone()
		{
			tblEQISO_Basedata_Pre objNew = (tblEQISO_Basedata_Pre)this.MemberwiseClone();
			return objNew;
		}
