...
namespace DDYZ.Ensis.Presistence.DataEntity
{
	...
	[Serializable]
	public class tblEQIW_L_DAQLTSTD : BaseDataEntity
	{
		[AttributePK]
		...
		/// </summary>
		/// <returns></returns>
		public tblEQIW_L_DAQLTSTD Clone()
		{
			tblEQIW_L_DAQLTSTD objNew = (tblEQIW_L_DAQLTSTD)this.MemberwiseClone();
			return objNew;
		}
