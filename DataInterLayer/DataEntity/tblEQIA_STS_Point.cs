...
namespace DDYZ.Ensis.Presistence.DataEntity
{
    ...
    [Serializable]
    public class tblEQIA_STS_Point : BaseDataEntity
    {
        [AttributePK]
        ...
        /// </summary>
        /// <returns></returns>
        public tblEQIA_STS_Point Clone()
        {
            tblEQIA_STS_Point objNew = (tblEQIA_STS_Point)this.MemberwiseClone();
            return objNew;
        }
