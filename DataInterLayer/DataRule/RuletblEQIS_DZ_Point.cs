...
{
    /// <summary>
    /// 功能描述    ：  对表[tblEQIS_DZ_Point]的数据操作
    /// 创建者      ：  Auto Generator
    /// 创建日期    ：  2015-03-30
    /// 修改者      ：
    /// 修改日期    ：
    ...
    {
        /// <summary>
        /// 功能描述    ：  根据当前年份获得潮间带海洋沉积物断面表的记录供GIS使用
        /// 创建者      ：  du
        /// 创建日期    ：  2015-03-30
        /// 修改者      ：
        /// 修改日期    ：
        ...
        public DataTable GetPointInfoForGis()
        {
            ...
            {
                throw new GetListException("打开数据库连接失败", "RuletblEQIS_DZ_Point", "GetPointInfoForGis", "");
            }
            catch (DBQueryException e)
            {
                throw new GetListException("执行Sql语句失败", "RuletblEQIS_DZ_Point", "GetPointInfoForGis", "");
            }
            catch (Exception e)
            {
