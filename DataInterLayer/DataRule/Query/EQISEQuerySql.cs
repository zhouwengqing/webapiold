...
namespace DDYZ.Ensis.Rule.BusinessRule.Query
{
    ...
    /// 修改原因    ：
    /// </summary>
    public class EQISEQuerySql : BaseRule
    {
        ...
        {
            return "fldAutoID desc,fldSTCode asc,fldRCode asc,fldRSCode asc,fldSampleType asc,fldSAMPH asc,fldRSC asc,fldYear desc,fldMonth desc,fldDay desc,fldHour desc ,fldItemCode asc";
        }
    }
}