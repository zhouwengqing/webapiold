...
namespace DDYZ.Ensis.Rule.DataRule
{
    ...
    { 
        ...
        public DataTable GetPointInfoForGis()
        {
            ...
            {
                throw new GetListException("打开数据库连接失败", "RuletblEQIS_W_Point", "GetPointInfoForGis", "");
            }
            catch (DBQueryException e)
            {
                throw new GetListException("执行Sql语句失败", "RuletblEQIS_W_Point", "GetPointInfoForGis", "");
            }
            catch (Exception e)
            {
