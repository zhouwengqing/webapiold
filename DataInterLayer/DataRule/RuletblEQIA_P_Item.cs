...
namespace DDYZ.Ensis.Rule.DataRule
{
    ...
    public class RuletblEQIA_P_Item : BaseRule
    {
        ...
        public DataTable GetAllData()
        {
            ...
            {
                throw new GetAllException("打开数据库连接失败", "RuletblEQIA_P_Item", "GetAllData", "");
            }
            catch (DBQueryException e)
            {
                throw new GetAllException("执行Sql语句失败", "RuletblEQIA_P_Item", "GetAllData", "");
            }
            catch (Exception e)
            {
