...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIB_Section_GetRSCodeByRCode : BaseProcedure
    {
        ...
        public usp_tblEQIB_Section_GetRSCodeByRCode()
        {
            base.InitCommand("usp_tblEQIB_Section_GetRSCodeByRCode");
            ConfigParameter();
        }
