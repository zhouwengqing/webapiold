...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIW_STS_Section_GetRSCodeByRole : BaseProcedure
    {
        ...
        public usp_tblEQIW_STS_Section_GetRSCodeByRole()
        {
            base.InitCommand("usp_tblEQIW_STS_Section_GetRSCodeByRole");
            ConfigParameter();
        }
