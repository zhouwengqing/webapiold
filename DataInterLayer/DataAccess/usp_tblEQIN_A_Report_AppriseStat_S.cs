...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQIN_A_Report_AppriseStat_S : BaseProcedure
	{
		...
		private SqlParameter parameterParmPeople;

		public usp_tblEQIN_A_Report_AppriseStat_S()
		{
			base.InitCommand("usp_tblEQIN_A_Report_AppriseStat_S");
			ConfigParameter();
		}
		...
		public System.Int32 ParmPeople
		{
			get
			{
				return (System.Int32)this.parameterParmPeople.Value;
			}
			set
			{
				this.parameterParmPeople.Value=value;
			}
		}
		...
		public void ConfigParameter()
		{
			...
			//--------------------------------------------------------
			this.parameterParmPeople=new SqlParameter();
			this.parameterParmPeople.ParameterName="@ParmPeople";
			this.parameterParmPeople.SqlDbType=SqlDbType.Int;
			this.parameterParmPeople.Size=4;
			this.parameterParmPeople.Direction=ParameterDirection.Input;
			base.m_cmd.Parameters.Add(this.parameterParmPeople);
		}
	}
}
