...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIW_D_Basedata_Pre_UpdateFlag : BaseProcedure
    {
        ...
        public usp_tblEQIW_D_Basedata_Pre_UpdateFlag()
        {
            base.InitCommand("usp_tblEQIW_D_Basedata_Pre_UpdateFlag");
            ConfigParameter();
        }
