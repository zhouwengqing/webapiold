...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQI_Item_Group_ByUserIDandObject : BaseProcedure
	{
		private SqlParameter parameterfldUserID;

		private SqlParameter parameterfldObject;

		public usp_tblEQI_Item_Group_ByUserIDandObject()
		{
			base.InitCommand("usp_tblEQI_Item_Group_ByUserIDandObject");
			ConfigParameter();
		}
