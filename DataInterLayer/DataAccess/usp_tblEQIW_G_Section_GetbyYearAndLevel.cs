...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIW_G_Section_GetbyYearAndLevel : BaseProcedure
    {
        ...
        public usp_tblEQIW_G_Section_GetbyYearAndLevel()
        {
            base.InitCommand("usp_tblEQIW_G_Section_GetbyYearAndLevel");
            ConfigParameter();
        }
