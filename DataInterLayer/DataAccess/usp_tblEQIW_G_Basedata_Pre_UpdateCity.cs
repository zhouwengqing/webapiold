...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIW_G_Basedata_Pre_UpdateCity : BaseProcedure
    {
        ...
        public usp_tblEQIW_G_Basedata_Pre_UpdateCity()
        {
            base.InitCommand("usp_tblEQIW_G_Basedata_Pre_UpdateCity");
            ConfigParameter();
        }
