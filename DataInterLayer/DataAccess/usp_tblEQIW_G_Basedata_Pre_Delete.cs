...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIW_G_Basedata_Pre_Delete : BaseProcedure
    {
        private SqlParameter parameterfldAutoID;

        public usp_tblEQIW_G_Basedata_Pre_Delete()
        {
            base.InitCommand("usp_tblEQIW_G_Basedata_Pre_Delete");
            ConfigParameter();
        }
