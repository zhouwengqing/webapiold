...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIN_M_Point_GetSTCodeByYearandCode : BaseProcedure
    {
        private SqlParameter parameterfldSTCode;

        private SqlParameter parameterfldYear;

        public usp_tblEQIN_M_Point_GetSTCodeByYearandCode()
        {
            base.InitCommand("usp_tblEQIN_M_Point_GetSTCodeByYearandCode");
            ConfigParameter();
        }
        ...
        public void ConfigParameter()
        {
            ...
            this.parameterfldSTCode.SqlDbType = SqlDbType.Int;
            this.parameterfldSTCode.Size = 4;
