...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_eqiw_r_autodataHour : BaseProcedure
    {
        ...
        public usp_eqiw_r_autodataHour()
        {
            base.InitCommand("usp_eqiw_r_autodataHour");
            ConfigParameter();
        }
