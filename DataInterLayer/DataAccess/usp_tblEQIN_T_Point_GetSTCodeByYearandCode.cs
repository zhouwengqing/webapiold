...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIN_T_Point_GetSTCodeByYearandCode : BaseProcedure
    {
        private SqlParameter parameterfldSTCode;

        private SqlParameter parameterfldYear;

        public usp_tblEQIN_T_Point_GetSTCodeByYearandCode()
        {
            base.InitCommand("usp_tblEQIN_T_Point_GetSTCodeByYearandCode");
            ConfigParameter();
        }
