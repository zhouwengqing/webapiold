...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQI_Point_Group_ByUserIDandObject_input : BaseProcedure
	{
		private SqlParameter parameterfldUserID;

		private SqlParameter parameterfldObject;

		public usp_tblEQI_Point_Group_ByUserIDandObject_input()
		{
			base.InitCommand("usp_tblEQI_Point_Group_ByUserIDandObject_input");
			ConfigParameter();
		}
