...
{
    public class usp_tblEQIW_D_Section_GetRCodeBySTCode_NofldSTCode : BaseProcedure
    {
        ...
        public usp_tblEQIW_D_Section_GetRCodeBySTCode_NofldSTCode()
        {
            base.InitCommand("usp_tblEQIW_D_Section_GetRCodeBySTCode_NofldSTCode");
            ConfigParameter();
        }
