...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIA_R_Point_GetPCodeByYear_New : BaseProcedure
	{
		private SqlParameter parameterfldSTCode;

		private SqlParameter parameterfldYear;

		public usp_tblEQIA_R_Point_GetPCodeByYear_New()
		{
			base.InitCommand("usp_tblEQIA_R_Point_GetPCodeByYear_New");
			ConfigParameter();
		}
