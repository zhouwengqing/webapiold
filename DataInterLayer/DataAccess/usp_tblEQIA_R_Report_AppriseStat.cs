...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQIA_R_Report_AppriseStat : BaseProcedure
	{
		...
		private SqlParameter parameterCityID;

		private SqlParameter parameterCalculateID;

		public usp_tblEQIA_R_Report_AppriseStat()
		{
			base.InitCommand("usp_tblEQIA_R_Report_AppriseStat");
			ConfigParameter();
		}
		...
		public System.Int32 CityID
		{
			get
			{
				return (System.Int32)this.parameterCityID.Value;
			}
			set
			{
				this.parameterCityID.Value=value;
			}
		}
		...
		public void ConfigParameter()
		{
			...
			//--------------------------------------------------------
			this.parameterCityID=new SqlParameter();
			this.parameterCityID.ParameterName="@CityID";
			this.parameterCityID.SqlDbType=SqlDbType.Int;
			this.parameterCityID.Size=4;
			this.parameterCityID.Direction=ParameterDirection.Input;
			base.m_cmd.Parameters.Add(this.parameterCityID);
			//--------------------------------------------------------
