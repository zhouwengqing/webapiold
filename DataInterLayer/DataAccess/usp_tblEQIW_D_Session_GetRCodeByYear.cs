...
{
    public class usp_tblEQIW_D_Session_GetRCodeByYear : BaseProcedure
    {
        private SqlParameter parameterfldSTCode;

        private SqlParameter parameterfldYear;

        public usp_tblEQIW_D_Session_GetRCodeByYear()
        {
            base.InitCommand("usp_tblEQIW_D_Session_GetRCodeByYear");
            ConfigParameter();
        }
