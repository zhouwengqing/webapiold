...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQIW_R_Basedata_WaterQuality_Page : BaseProcedure
	{
		private SqlParameter parameterfldSTCode;

		public usp_tblEQIW_R_Basedata_WaterQuality_Page()
		{
			base.InitCommand("usp_tblEQIW_R_Basedata_WaterQuality_Page");
			ConfigParameter();
		}
