...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIW_DT_Section_GetRCodeBySTCode : BaseProcedure
    {
        ...
        public usp_tblEQIW_DT_Section_GetRCodeBySTCode()
        {
            base.InitCommand("usp_tblEQIW_DT_Section_GetRCodeBySTCode");
            ConfigParameter();
        }
