...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIA_STS_Point_GetPCodeByRole : BaseProcedure
    {
        ...
        public usp_tblEQIA_STS_Point_GetPCodeByRole()
        {
            base.InitCommand("usp_tblEQIA_STS_Point_GetPCodeByRole");
            ConfigParameter();
        }
