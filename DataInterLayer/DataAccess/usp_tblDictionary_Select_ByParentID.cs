...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblDictionary_Select_ByParentID : BaseProcedure
	{
		private SqlParameter parameterfldAutoID;

        public usp_tblDictionary_Select_ByParentID()
		{
			base.InitCommand("usp_tblDictionary_Select_ByParentID");
			ConfigParameter();
		}
