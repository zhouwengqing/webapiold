...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQIW_D_Section_GetRCodeBySTCode_New : BaseProcedure
	{
		private SqlParameter parameterfldSTCode;

		private SqlParameter parameterfldYear;

		public usp_tblEQIW_D_Section_GetRCodeBySTCode_New()
		{
			base.InitCommand("usp_tblEQIW_D_Section_GetRCodeBySTCode_New");
			ConfigParameter();
		}
