...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQIW_L_Section_ByRiverSystemType : BaseProcedure
	{
		private SqlParameter parameterfldType;

		private SqlParameter parameterfldYear;

		public usp_tblEQIW_L_Section_ByRiverSystemType()
		{
			base.InitCommand("usp_tblEQIW_L_Section_ByRiverSystemType");
			ConfigParameter();
		}
