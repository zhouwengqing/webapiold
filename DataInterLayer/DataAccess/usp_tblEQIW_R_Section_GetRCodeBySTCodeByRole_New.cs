...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIW_R_Section_GetRCodeBySTCodeByRole_New : BaseProcedure
	{
		private SqlParameter parameterfldSTCode;

		private SqlParameter parameterfldYear;

        public usp_tblEQIW_R_Section_GetRCodeBySTCodeByRole_New()
		{
			base.InitCommand("usp_tblEQIW_R_Section_GetRCodeBySTCodeByRole_New");
			ConfigParameter();
		}
