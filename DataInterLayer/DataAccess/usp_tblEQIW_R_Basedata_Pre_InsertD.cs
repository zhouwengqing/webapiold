...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIW_R_Basedata_Pre_InsertD : BaseProcedure
    {
        ...
        public usp_tblEQIW_R_Basedata_Pre_InsertD()
        {
            base.InitCommand("usp_tblEQIW_R_Basedata_Pre_InsertD");
            ConfigParameter();
        }
