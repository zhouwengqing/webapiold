...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQIW_RL_Report_Apprise : BaseProcedure
	{
		...
		private SqlParameter parameterPara2ID;

		private SqlParameter parameterSource;

		public usp_tblEQIW_RL_Report_Apprise()
		{
			base.InitCommand("usp_tblEQIW_RL_Report_Apprise");
			ConfigParameter();
		}
		...
		public System.Int32 Para2ID
		{
			get
			{
				return (System.Int32)this.parameterPara2ID.Value;
			}
			set
			{
				this.parameterPara2ID.Value=value;
			}
		}
		...
		public void ConfigParameter()
		{
			...
			//--------------------------------------------------------
			this.parameterPara2ID=new SqlParameter();
			this.parameterPara2ID.ParameterName="@Para2ID";
			this.parameterPara2ID.SqlDbType=SqlDbType.Int;
			this.parameterPara2ID.Size=4;
			this.parameterPara2ID.Direction=ParameterDirection.Input;
			base.m_cmd.Parameters.Add(this.parameterPara2ID);
			//--------------------------------------------------------
