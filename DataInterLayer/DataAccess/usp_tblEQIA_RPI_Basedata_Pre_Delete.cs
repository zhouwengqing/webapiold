...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIA_RPI_Basedata_Pre_Delete : BaseProcedure
    {
        private SqlParameter parameterfldAutoID;

        public usp_tblEQIA_RPI_Basedata_Pre_Delete()
        {
            base.InitCommand("usp_tblEQIA_RPI_Basedata_Pre_Delete");
            ConfigParameter();
        }
