...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQIA_P_Point_GetPCodeByYear : BaseProcedure
	{
		private SqlParameter parameterfldSTCode;

		private SqlParameter parameterfldYear;

		public usp_tblEQIA_P_Point_GetPCodeByYear()
		{
			base.InitCommand("usp_tblEQIA_P_Point_GetPCodeByYear");
			ConfigParameter();
		}
