...
namespace DDYZ.Ensis.DataSource.DataAccess
{
    ...
    public class usp_tblEQIN_A_Point_GetGDCODEByYear : BaseProcedure
    {
        private SqlParameter parameterfldSTCode;

        private SqlParameter parameterfldYear;

        public usp_tblEQIN_A_Point_GetGDCODEByYear()
        {
            base.InitCommand("usp_tblEQIN_A_Point_GetGDCODEByYear");
            ConfigParameter();
        }
