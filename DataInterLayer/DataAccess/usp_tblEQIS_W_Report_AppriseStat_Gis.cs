...
namespace DDYZ.Ensis.DataSource.DataAccess
{
	...
	public class usp_tblEQIS_W_Report_AppriseStat_Gis : BaseProcedure
	{
		...
		private SqlParameter parameterfldSeaRegionName;
		...
		public usp_tblEQIS_W_Report_AppriseStat_Gis()
		{
			base.InitCommand("usp_tblEQIS_W_Report_AppriseStat_Gis");
			ConfigParameter();
		}
		...
		public System.String fldSeaRegionName
		{
			get
			{
				return (System.String)this.parameterfldSeaRegionName.Value;
			}
			set
			{
				this.parameterfldSeaRegionName.Value=value;
			}
		}
		...
		public void ConfigParameter()
		{
			...
			//--------------------------------------------------------
			this.parameterfldSeaRegionName=new SqlParameter();
			this.parameterfldSeaRegionName.ParameterName="@fldSeaRegionName";
			this.parameterfldSeaRegionName.SqlDbType=SqlDbType.VarChar;
			this.parameterfldSeaRegionName.Size=50;
			this.parameterfldSeaRegionName.Direction=ParameterDirection.Input;
			base.m_cmd.Parameters.Add(this.parameterfldSeaRegionName);
			//--------------------------------------------------------
			...
			this.parameterfldPCode.Size=50;
