...
namespace WebAPIClient.Pay
{
    ...
    /// 
    /// </summary>
    public partial class ScanWX : System.Web.UI.Page
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string serviceAddress = "http://localhost:7983/actionapi/weixin/pay?OrderID=" + OrderID + "&tid=" + tid;
