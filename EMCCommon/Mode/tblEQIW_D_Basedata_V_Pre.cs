namespace EMCCommon.Mode
{
    ...
    public partial class tblEQIW_D_Basedata_V_Pre
    {
        [Key]
        ...
        [Column(TypeName = "numeric")]
        public decimal fld304 { get; set; }

        [Column(TypeName = "numeric")]
        public decimal fld309 { get; set; }

        [Column(TypeName = "numeric")]
        public decimal fld310 { get; set; }

        [Column(TypeName = "numeric")]
        public decimal fld432 { get; set; }

        [Column(TypeName = "numeric")]
        public decimal fld433 { get; set; }

        [Column(TypeName = "numeric")]
        public decimal fld462 { get; set; }

        [Column(TypeName = "numeric")]
        public decimal fld329 { get; set; }
