...
namespace EMCControls_DemoMiddle.Eqiw.eqiw_r
{
    ...
    /// 获得河流数据
    /// </summary>
    public class GetRiverDataController : ApiController
    {
        ...
        /// 
        [HttpPost]
        public HttpResponseMessage GetRiverdata(DataParameter DP)
        {
            string result = "";
            string defwhere = "1=1";
            ...
            try
            {
                ...
                if (rule.Judge(DP.rcode))
                {
                    ...
                    defwhere2 += " and fldRCode='" + DP.rcode + "'";
                }
                ...
                #endregion
                //当期
                string sql = "select * from vwtblEQIW_R_RiverData where " + defwhere + where1;


                //累计
                string sql2 = "select * from vwtblEQIW_R_RiverData where " + defwhere2 + where2;
                //同期
                string sql3 = "select * from vwtblEQIW_R_RiverData where " + defwhere + where3;

                string sql4 = "select * from vwtblEQIW_R_RiverData where " + defwhere + where4;

                string sql5 = "select * from vwtblEQIW_R_RiverData where " + defwhere + where5;
