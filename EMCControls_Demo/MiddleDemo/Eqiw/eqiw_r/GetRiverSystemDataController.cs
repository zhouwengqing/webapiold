...
namespace EMCControls_DemoMiddle.Eqiw.eqiw_r
{
    ...
    /// 创建时间：2017/09/26
    /// </summary>
    public class GetRiverSystemDataController : ApiController
    {
        ...
        /// 
        [HttpPost]
        public HttpResponseMessage GetRiverSystemdata(DataParameter DP)
        {
            string result = "";
            string defwhere = "1=1";
            ...
            try
            {
                ...
                {
                    defwhere += " and fldRSystem='" + DP.sRname + "'";
                    defwhere2 += " and fldRSystem='" + DP.sRname + "'";
                }
                ...
                #endregion
                //当期
                string sql = "select * from vwtblEQIW_R_RiverSystemData where " + defwhere + where1;
                //累计
                string sql2 = "select * from vwtblEQIW_R_RiverSystemData where " + defwhere2 + where2;
                //同期
                string sql3 = "select * from vwtblEQIW_R_RiverSystemData where " + defwhere + where3;

                string sql4 = "select * from vwtblEQIW_R_RiverSystemData where " + defwhere + where4;

                string sql5 = "select * from vwtblEQIW_R_RiverSystemData where " + defwhere + where5;
