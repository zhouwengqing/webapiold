...
namespace EMCControls_DemoMiddle.Eqiw.eqiw_l
{
    ...
    /// 获得湖库数据
    /// </summary>
    public class GetHKDataController : ApiController
    {
        ...
        /// 
        [HttpPost]
        public HttpResponseMessage GetHKdata(DataParameter DP)
        {
            string result = "";
            string defwhere = "1=1";
            ...
            try
            {
                ...
                #endregion
                //当期
                string sql = "select * from vwtblEQIW_L_HKData where " + defwhere + where1;
                //累计
                string sql2 = "select * from vwtblEQIW_L_HKData where " + defwhere2 + where2;
                //同期
                string sql3 = "select * from vwtblEQIW_L_HKData where " + defwhere + where3;

                string sql4 = "select * from vwtblEQIW_L_HKData where " + defwhere + where4;

                string sql5 = "select * from vwtblEQIW_L_HKData where " + defwhere + where5;
