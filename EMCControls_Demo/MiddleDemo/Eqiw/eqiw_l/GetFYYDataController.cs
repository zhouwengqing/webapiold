...
namespace EMCControls_DemoMiddle.Eqiw.eqiw_l
{
    ...
    /// 获得富营养的值
    /// </summary>
    public class GetFYYDataController : ApiController
    {
        ...
        /// 
        [HttpPost]
        public HttpResponseMessage GetFYYdata(DataParameter DP)
        {
            string result = "";
            string defwhere = "1=1";
            ...
            try
            {
                ...
                sql = "select * from vwtblEQIW_R_FYYData where " + defwhere + where1;
                sql2 = "select * from vwtblEQIW_R_FYYData where " + defwhere2 + where2;
                sql3 = "select * from vwtblEQIW_R_FYYData where " + defwhere + where3;
