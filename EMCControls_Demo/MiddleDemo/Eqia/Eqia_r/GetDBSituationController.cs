...
namespace EMCControls_DemoMiddle.Eqia.Eqia_r
{
    ...
    /// 全省达标情况
    /// </summary>
    public class GetDBSituationController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public HttpResponseMessage GetCityDB(GisParameter GP)
        {
            string result = "";
            string where = "1=1";
            string where2 = "1=1";
            try
            {
                ...
                string sql = "select * from tblEQIA_R_DB where " + where;
