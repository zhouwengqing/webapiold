...
namespace EMCControls_DemoMiddle.Common
{
    ...
    /// 获取城市经纬度
    /// </summary>
    public class City_GIS_LivingController : ApiController
    {
        ...
        /// <returns></returns>
        public HttpResponseMessage GetCityLatitudeAndLongitude(string stcode = "-1")
        {
            string result = string.Empty;
            try
            {
                DataTable dt = Middle.GetCity_Select(stcode);
