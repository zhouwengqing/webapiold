...
namespace EMCControls_DemoMiddleDemo.Eqin.Eqin_F
{
    public class GetEQIN_F_DataController : ApiController
    {
        ...
        /// 
        [HttpPost]
        public HttpResponseMessage GetNFData(DataParameter DP)
        {
            string result = "";
            string defwhere = "1=1";
            ...
            try
            {
                ...
                //当期
                string sql = "select * from vwtblEQIN_F_Data where " + defwhere + where1;

                //同期
                string sql3 = "select * from vwtblEQIN_F_Data where " + defwhere + where3;
