namespace EMCControls_Middle.Middle.Model
{
    ...
    public partial class tblEQIW_L_TatalSectStat_Z_Midd
    {
        [Key]
        ...
        [StringLength(20)]
        public string fldFun2020 { get; set; }

        [StringLength(100)]
        public string fldFun2020Name { get; set; }

        [StringLength(10)]
        public string fldIsStand { get; set; }
        ...
        public string fldMaxItemOverItem { get; set; }
