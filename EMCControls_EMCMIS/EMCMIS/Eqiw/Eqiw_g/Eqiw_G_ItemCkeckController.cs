...
namespace EMCControls_EMCMIS.Eqiw.Eqiw_g
{
    ...
    /// 地下水检查
    /// </summary>
    public class Eqiw_G_ItemCkeckController : ApiController
    {
        ...
        [HttpGet]
        //
        public HttpResponseMessage Geteqiw_g_daySTG(string itemcontent, string standardnum, string std, string type)
        {
            string result = string.Empty;
            try
            {
                RuletblEQIW_G_DAQLTSTD rule_itemstd = new RuletblEQIW_G_DAQLTSTD();
                List<ItemSTD> itemstd = new List<ItemSTD>();
                IList<tblEQIW_G_DAQLTSTD> list = rule_itemstd.GetSTD(itemcontent, standardnum);
