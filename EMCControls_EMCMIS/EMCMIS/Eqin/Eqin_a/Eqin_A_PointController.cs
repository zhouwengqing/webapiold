...
namespace EMCControls_EMCMIS.Eqin.Eqin_a
{
    ...
    /// 区域噪声获取测点
    /// </summary>
    public class Eqin_A_PointController : ApiController
    {
        ...
        [HttpGet]
        //
        public HttpResponseMessage GetEqin_A_ddlPName(string Edate, string stcode)
        {
            ...
            try
            {
                ...
                {
                    RuletblEQIN_A_Point rule_point = new RuletblEQIN_A_Point();
                    IList<tblEQIN_A_Point> list = rule_point.GetGDCODEByYear(stcode, Convert.ToInt32(Edate));
